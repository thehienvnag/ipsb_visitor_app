                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Icon(Icons.api_sharp,size: 15,color: Colors.lightBlue,),
                                Text("Áp dụng cho toàn sản phẩm size L ", style: TextStyle(fontSize: 15),),
                              ],
                            ),
                            Row(
                              children: [
                                Icon(Icons.api_sharp,size: 15,color: Colors.lightBlue,),
                                Text("Toàn menu (không áp dụng combo) ", style: TextStyle(fontSize: 15),),
                              ],
                            ),
                            Row(
                              children: [
                                Icon(Icons.api_sharp,size: 15,color: Colors.lightBlue,),
                                Text("Áp dụng nhiều sản phẩm trong 1 hóa đơn", style: TextStyle(fontSize: 15),),
                              ],
                            ),
                            SizedBox(height: 5,),
                            Text(
                            ...
                            Row(
                              children: [
                                Icon(Icons.api_sharp,size: 15,color: Colors.lightBlue,),
                                Text("Giá chưa bao gồm VAT ", style: TextStyle(fontSize: 16),),
                              ],
                            ),
                            Row(
                              children: [
                                Icon(Icons.api_sharp,size: 15,color: Colors.lightBlue,),
                                Text("Không đồng thời áp dụng việc tích điểm ", style: TextStyle(fontSize: 15),),
                              ],
                            ),
                            Row(
                              children: [
                                Icon(Icons.api_sharp,size: 15,color: Colors.lightBlue,),
                                Text("Mỗi người chỉ áp dụng 1 thiết bị chứa mã",style: TextStyle(fontSize: 15)),
                              ],
                            ),
                            Row(
                              children: [
                                Icon(Icons.api_sharp,size: 15,color: Colors.lightBlue,),
                                Text('Không dùng chung với khuyến mãi khác',style: TextStyle(fontSize: 15)),
                              ],
                            ),
                            Row(
                              children: [
                                Icon(Icons.api_sharp,size: 15,color: Colors.lightBlue,),
                                Text("Chỉ áp dụng tại cửa hàng", style: TextStyle(fontSize: 15),),
                              ],
                            ),
                            Row(
                              children: [
                                Icon(Icons.api_sharp,size: 15,color: Colors.lightBlue,),
                                Text("Khi thanh toán chỉ áp dụng 1 mã", style: TextStyle(fontSize: 15),
                                ),
                              ],
                            ),
                            Row(
                              children: [
                                Icon(Icons.api_sharp,size: 15,color: Colors.lightBlue,),
                                Text("Không áp dụng hình chụp màn hình",style: TextStyle(fontSize: 15)),
                              ],
                            ),
                            SizedBox(height: 25),
                            Row(
