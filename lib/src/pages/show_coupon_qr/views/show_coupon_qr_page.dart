...
class ShowCouponQRPage extends GetView<ShowCouponQRController> {
  ...
  const ShowCouponQRPage(this.coupon);
              ...
              child: Container(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Giảm 30k cho đơn từ 100k', style: TextStyle(
                          color: Colors.red,
                          fontSize: 20,
                      ...
                      SizedBox(height: 20),
                      Center(
                        child: Text('Đưa mã này cho nhân viên quét để kích hoặt',
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 16,
                              fontWeight: FontWeight.bold),),
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Text('Thời gian áp dụng: ', style: TextStyle(
                              color: Colors.black,
                              fontSize: 15,
                              fontWeight: FontWeight.bold),),
                        ),
                        Text(coupon!.publishDate.toString(),)
                      ],
                    ),
                    Row(
                      children: [
                        Container(
                          alignment: Alignment.topLeft,
                          child: Text('Chương trình: ', style: TextStyle(
                              color: Colors.black,
                              fontSize: 15,
                              fontWeight: FontWeight.bold),),
                        ),
